...
;Welcome page
LangString WELCOME_PAGE_TEXT ${LANG_GREEK} "Αυτό το πρόγραμμα εγκατάστασης θα σας καθοδηγήσει κατά την εγκατάσταση του Trace ${PACKAGE_VERSION}.$\r$\n$\r$\n\
...
;Error messages
LangString ERROR_WIN_MIN    ${LANG_GREEK} "A minimum of Windows 8.1 is required to install Trace using this installer"
...
LangString DESC_SEC_FILE_ASSOC ${LANG_GREEK} "Creates file associations for Trace related files"
...
LangString FILE_DESC_KICAD_PCB ${LANG_GREEK} "Trace Board"
LangString FILE_DESC_SCH ${LANG_GREEK} "Trace Schematic"
LangString FILE_DESC_PRO ${LANG_GREEK} "Trace Project"
LangString FILE_DESC_KICAD_WKS ${LANG_GREEK} "Trace Drawing Sheet"
LangString FILE_DESC_SYM ${LANG_GREEK} "Trace Symbol"
LangString FILE_DESC_FP ${LANG_GREEK} "Trace Footprint"

;Application Friendly Names (for windows explorer hook)
LangString APP_FRIENDLY_TRACE ${LANG_SPANISH} "Trace"
LangString APP_FRIENDLY_PCBNEW ${LANG_GREEK} "Trace - PCB Editor"
LangString APP_FRIENDLY_EESCHEMA ${LANG_GREEK} "Trace - Schematic Editor"
LangString APP_FRIENDLY_PLEDITOR ${LANG_GREEK} "Trace - Drawing Sheet Editor"

;Application names
LangString APP_NAME_TRACE ${LANG_GREEK} "Trace (trace.exe)"
...
;Shortcut names
LangString SHORTCUT_NAME_EESCHEMA ${LANG_GREEK} "Schematic Editor ${TRACE_VERSION} (standalone)"
LangString SHORTCUT_NAME_PCBNEW ${LANG_GREEK} "PCB Editor ${TRACE_VERSION} (standalone)"
LangString SHORTCUT_NAME_GERBVIEW ${LANG_GREEK} "Gerber Viewer ${TRACE_VERSION}"
LangString SHORTCUT_NAME_BITMAP2COMPONENT ${LANG_GREEK} "Image Converter ${TRACE_VERSION}"
LangString SHORTCUT_NAME_PCBCALCULATOR ${LANG_GREEK} "Calculator Tools ${TRACE_VERSION}"
LangString SHORTCUT_NAME_PLEDITOR ${LANG_GREEK} "Drawing Sheet Editor ${TRACE_VERSION}"
LangString SHORTCUT_NAME_CMD ${LANG_GREEK} "Trace ${TRACE_VERSION} Command Prompt"
...
LangString UNINST_PREV_VERSION_PROMPT ${LANG_GREEK} "A previous version of Trace ($R1) was found at:$\r$\n$R0$\r$\n$\r$\nWould you like to uninstall it before continuing?"
...
LangString UNINSTALL_OPTIONS_REMOVE_ALL_SETTINGS ${LANG_GREEK} "Would you like to remove all stored Trace settings? (current user files only)"