...
;Welcome page
LangString WELCOME_PAGE_TEXT ${LANG_SPANISH} "Este asistente le guiará durante la instalación de Trace ${PACKAGE_VERSION}.$\r$\n$\r$\n\
...
;Error messages
LangString ERROR_WIN_MIN    ${LANG_SPANISH} "A minimum of Windows 8.1 is required to install Trace using this installer"
...
LangString DESC_SEC_FILE_ASSOC ${LANG_SPANISH} "Creates file associations for Trace related files"
...
LangString FILE_DESC_KICAD_PCB ${LANG_SPANISH} "Trace Board"
LangString FILE_DESC_SCH ${LANG_SPANISH} "Trace Schematic"
LangString FILE_DESC_PRO ${LANG_SPANISH} "Trace Project"
LangString FILE_DESC_KICAD_WKS ${LANG_SPANISH} "Trace Drawing Sheet"
LangString FILE_DESC_SYM ${LANG_SPANISH} "Trace Symbol"
LangString FILE_DESC_FP ${LANG_SPANISH} "Trace Footprint"

;Application Friendly Names (for windows explorer hook)
LangString APP_FRIENDLY_TRACE ${LANG_SPANISH} "Trace"
LangString APP_FRIENDLY_PCBNEW ${LANG_SPANISH} "Trace - PCB Editor"
LangString APP_FRIENDLY_EESCHEMA ${LANG_SPANISH} "Trace - Schematic Editor"
LangString APP_FRIENDLY_PLEDITOR ${LANG_SPANISH} "Trace - Drawing Sheet Editor"

;Application names
LangString APP_NAME_TRACE ${LANG_SPANISH} "Trace (trace.exe)"
...
;Shortcut names
LangString SHORTCUT_NAME_EESCHEMA ${LANG_SPANISH} "Schematic Editor ${TRACE_VERSION} (standalone)"
LangString SHORTCUT_NAME_PCBNEW ${LANG_SPANISH} "PCB Editor ${TRACE_VERSION} (standalone)"
LangString SHORTCUT_NAME_GERBVIEW ${LANG_SPANISH} "Gerber Viewer ${TRACE_VERSION}"
LangString SHORTCUT_NAME_BITMAP2COMPONENT ${LANG_SPANISH} "Image Converter ${TRACE_VERSION}"
LangString SHORTCUT_NAME_PCBCALCULATOR ${LANG_SPANISH} "Calculator Tools ${TRACE_VERSION}"
LangString SHORTCUT_NAME_PLEDITOR ${LANG_SPANISH} "Drawing Sheet Editor ${TRACE_VERSION}"
LangString SHORTCUT_NAME_CMD ${LANG_SPANISH} "Trace ${TRACE_VERSION} Command Prompt"
...
LangString UNINST_PREV_VERSION_PROMPT ${LANG_SPANISH} "A previous version of Trace ($R1) was found installed at:$\r$\n$R0$\r$\n$\r$\nIt will be uninstalled before continuing."
LangString UNINST_PREV_VERSION_FAILED ${LANG_SPANISH} "Failed to uninstall previous Trace version ($R1). You may need to remove it manually."
LangString UNINST_PREV_VERSION_REMOVING ${LANG_SPANISH} "Removing previous Trace version..."
...
LangString UNINSTALL_OPTIONS_REMOVE_ALL_SETTINGS ${LANG_SPANISH} "Would you like to remove all stored Trace settings? (current user files only)"