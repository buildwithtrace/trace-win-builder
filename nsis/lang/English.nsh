...
;Welcome page
LangString WELCOME_PAGE_TEXT ${LANG_ENGLISH} "This installer will guide you through the installation of Trace ${PACKAGE_VERSION}.$\r$\n$\r$\n\
...
;Error messages
LangString ERROR_WIN_MIN    ${LANG_ENGLISH} "A minimum of Windows 8.1 is required to install Trace using this installer"
...
LangString DESC_SEC_FILE_ASSOC ${LANG_ENGLISH} "Creates file associations for Trace related files"
...
LangString FILE_DESC_KICAD_PCB ${LANG_ENGLISH} "Trace Board"
LangString FILE_DESC_SCH ${LANG_ENGLISH} "Trace Schematic"
LangString FILE_DESC_SYM ${LANG_ENGLISH} "Trace Symbol"
LangString FILE_DESC_FP ${LANG_ENGLISH} "Trace Footprint"
LangString FILE_DESC_PRO ${LANG_ENGLISH} "Trace Project"
LangString FILE_DESC_KICAD_WKS ${LANG_ENGLISH} "Trace Drawing Sheet"

;Application Friendly Names (for windows explorer hook)
LangString APP_FRIENDLY_TRACE ${LANG_ENGLISH} "Trace"
LangString APP_FRIENDLY_TRACE ${LANG_ENGLISH} "Trace"
LangString APP_FRIENDLY_PCBNEW ${LANG_ENGLISH} "Trace - PCB Editor"
LangString APP_FRIENDLY_EESCHEMA ${LANG_ENGLISH} "Trace - Schematic Editor"
LangString APP_FRIENDLY_PLEDITOR ${LANG_ENGLISH} "Trace - Page Layout Editor"

;Application names
LangString APP_NAME_TRACE ${LANG_ENGLISH} "Trace (trace.exe)"
LangString APP_NAME_TRACE ${LANG_ENGLISH} "Trace (trace.exe)"
...
;Shortcut names
LangString SHORTCUT_NAME_EESCHEMA ${LANG_ENGLISH} "Schematic Editor ${TRACE_VERSION} (standalone)"
LangString SHORTCUT_NAME_PCBNEW ${LANG_ENGLISH} "PCB Editor ${TRACE_VERSION} (standalone)"
LangString SHORTCUT_NAME_GERBVIEW ${LANG_ENGLISH} "Gerber Viewer ${TRACE_VERSION}"
LangString SHORTCUT_NAME_BITMAP2COMPONENT ${LANG_ENGLISH} "Image Converter ${TRACE_VERSION}"
LangString SHORTCUT_NAME_PCBCALCULATOR ${LANG_ENGLISH} "Calculator Tools ${TRACE_VERSION}"
LangString SHORTCUT_NAME_PLEDITOR ${LANG_ENGLISH} "Drawing Sheet Editor ${TRACE_VERSION}"
LangString SHORTCUT_NAME_CMD ${LANG_ENGLISH} "Trace ${TRACE_VERSION} Command Prompt"
...
This will also remove all files, symbols and footprints in the Trace installation directory. Any of your Trace files located outside the installation\
...
LangString UNINSTALL_OPTIONS_REMOVE_ALL_SETTINGS ${LANG_ENGLISH} "Would you like to remove all stored Trace settings? (current user files only)"